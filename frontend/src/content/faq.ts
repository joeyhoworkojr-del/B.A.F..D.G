...
export const FAQ: FaqEntry[] = [
  ...
  },
  {
    ...
    a: [
      'Only in the app. The notification centre in the header lists the graded edges the model is publishing right now, and what you have already seen resets when you close the tab.',
